...
public class MemoryChallenge extends AppCompatActivity {
    ...
    private void SetUp() {
        ...
        logo = R.drawable.logo; pooh = R.drawable.naruto; mic =  R.drawable.chopper; goofy = R.drawable.zoro;
        lionking = R.drawable.sanji; pinocio = R.drawable.luffyy; mini = R.drawable.ichigo;
    }
